...
* Remove extra slashes (\) from reports

= 1.6.1 =
* Fixed server error triggered in the absence of Akismet

= 1.6.0 =
* Updated the spam checking logic to work with the latest version of Akismet
* Fixed typo
