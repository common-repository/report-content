...
class WPRC_Table extends WPRC_List_Table {
	...
	function column_post( $item ) {
		...
		return esc_html__( 'Post Not Found', 'report-content' );
	}
	...
	function get_bulk_actions() {
		...
		$actions = array(
			'change_status' => esc_html__( 'Mark as resolved', 'report-content' ),
			'delete'        => esc_html__( 'Delete', 'report-content' ),
		);
		return $actions;
	}
	...
	function get_columns() {
		$columns = array(
			...
			'reason'   => esc_html__( 'Issue', 'report-content' ),
			'status'   => esc_html__( 'Status', 'report-content' ),
			'details'  => esc_html__( 'Details', 'report-content' ),
			'time'     => esc_html__( 'Time', 'report-content' ),
			'reporter' => esc_html__( 'Reporter', 'report-content' ),
			'post'     => esc_html__( 'Post', 'report-content' ),
		);
		return $columns;
	}
